...
utils.waitForElement('body').then(function(){
    ...
    $('.fixScroll .addSection__form').appendTo('.prodInfoNav ul').wrap('<li class="no-underline"></li>').hide();
    ...
    $(document).scroll(function () {
        ...
        if (y > startPosition) {
            $('.prodInfoNav .addSection__form').show();
            nav.addClass('sticky');
            if (y > stopPosition) {
            ...
            $('.prodInfoNav .addSection__form').hide();
